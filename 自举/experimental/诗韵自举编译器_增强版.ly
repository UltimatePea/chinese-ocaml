...
夫「春江潮水连海平」者受 源码文本 焉算法乃
  ...
  问 源码文本 之长度 大于 但愿人长久 则（
    ...
    ）也 问 此时相望不相闻 等于 『\t』 则（
      ...
      继续  
    ）也 问 此时相望不相闻 等于 『（』 则（
      让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线LP增强现实EN 』 在
      让「但愿人长久」等于 但愿人长久 加 1 在
    ）也 问 此时相望不相闻 等于 『）』 则（
      让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线RP增强现实EN 』 在  
      让「但愿人长久」等于 但愿人长久 加 1 在
    ）也 问 此时相望不相闻 等于 『「』 则（
      让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线LBRACE 』 在
      让「但愿人长久」等于 但愿人长久 加 1 在
    ）也 问 此时相望不相闻 等于 『」』 则（
      让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线RBRACE 』 在
      让「但愿人长久」等于 但愿人长久 加 1 在
    ）也（
      「斜月沉沉藏海雾，碣石潇湘无限路」
      「识别标识符和关键字」
      ...
      问（但愿人长久 等于 源码文本之长度） 或者 （获取字符 源码文本 但愿人长久 为空白字符）则（
        问 千里共婵娟 等于 『夫』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线FUNCTI开 』 在
        ）也 问 千里共婵娟 等于 『让』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线LET 』 在  
        ）也 问 千里共婵娟 等于 『在』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线IN 』 在
        ）也 问 千里共婵娟 等于 『问』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线IF 』 在
        ）也 问 千里共婵娟 等于 『则』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线THEN 』 在
        ）也 问 千里共婵娟 等于 『也』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线ELSE 』 在
        ）也 问 千里共婵娟 等于 『答』 则（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线RETURN 』 在
        ）也（
          让「明月共潮生」等于 明月共潮生 连接 『T好EN下划线标识ENTIFIER：』 连接 千里共婵娟 连接 『 』 在
        ）
        让「千里共婵娟」等于『』 在  「重置当前词素」
      ）
    ）
...
夫「花间一壶酒」者受 词法单元列表 焉算法乃
  ...
  夫「醉卧沙场君莫笑」者受 无 焉算法乃  「解析函数定义」
    问 影徒随我身之长度 大于 暂伴月将影 则（
      ...
      问 古来征战几人回 开始于 『T好EN下划线FUNCTI开』 则（
        让「暂伴月将影」等于 暂伴月将影 加 1 在
        让「葡萄美酒夜光杯」等于『AST下划线FUNCTI开』 在
  ...
  夫「欲饮琵琶马上催」者受 无 焉算法乃  「解析表达式」  
    问 影徒随我身之长度 大于 暂伴月将影 则（
      让「古来征战几人回」等于获取元素 影徒随我身 暂伴月将影 在
      问 古来征战几人回 开始于 『T好EN下划线标识ENTIFIER』 则（
        让「暂伴月将影」等于 暂伴月将影 加 1 在
        让「葡萄美酒夜光杯」等于『AST下划线标识ENTIFIER』 在  
        让「月既不解饮」等于 月既不解饮 连接 葡萄美酒夜光杯 在
        答 『标识符已解析』 也  
      ）也
    ）也
...
』 在
  ...
  问 写入结果 等于 『成功』 则（
    让「人生得意须尽欢」等于打印 『编译成功！丙代码已生成到： 』 连接 输出文件 在
    答 『编译成功』 也  
  ）也（
    答 『写入失败』 也
  ）
