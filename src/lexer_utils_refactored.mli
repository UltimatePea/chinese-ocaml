...
val recognize_chinese_punctuation : Lexer_state.t -> Lexer_tokens.position -> (Lexer_tokens.token * Lexer_tokens.position * Lexer_state.t) option
val recognize_pipe_right_bracket : Lexer_state.t -> Lexer_tokens.position -> (Lexer_tokens.token * Lexer_tokens.position * Lexer_state.t) option
