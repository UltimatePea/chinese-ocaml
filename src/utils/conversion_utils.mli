...
(** 条件转换器 - 根据条件选择不同的转换策略 *)
val conditional_converter : ('a -> bool) -> ('b -> 'a -> ('c, string) result) -> ('b -> 'a -> ('c, string) result) -> 'b -> 'a -> ('c, string) result

(** 带回退的转换器 *)
val converter_with_fallback : ('a -> 'b -> ('c, string) result) -> ('a -> 'b -> ('c, string) result) -> 'a -> 'b -> ('c, string) result
...
(** 转换器组合 *)
val compose_converters : ('a -> 'b -> ('c, string) result) -> ('a -> 'c -> ('d, string) result) -> 'a -> 'b -> ('d, string) result
...
(** 带统计的转换器包装器 *)
val converter_with_stats : ('a -> 'b -> ('c, string) result) -> conversion_stats ref -> 'a -> 'b -> ('c, string) result