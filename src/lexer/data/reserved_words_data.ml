...
module ReservedWordCategories = struct
  (** 基本数据类型相关 *)
  let basic_data_types = [
    "浮点"; "字符";
  ]

  (** 函数式编程概念 *)
  let functional_programming = [
    "高阶"; "柯里"; "部分应用"; "函数组合"; "不动点";
  ]

  (** 类型系统相关 *)
  let type_system = [
    "约束"; "推断"; "多态"; "单态"; "协变"; "逆变"; "不变";
  ]
  ...
  (** 编译器内部相关 *)
  let compiler_internals = [
    "词法"; "语法"; "语义"; "代码生成"; "优化"; "调试信息";
  ]
  ...
  (** IO和系统相关 *)
  let io_and_system = [
    "标准输入"; "标准输出"; "标准错误"; "文件系统"; "网络";
  ]

  (** 数学计算相关 *)
  let mathematical_computing = [
    "精确计算"; "浮点误差"; "无穷"; "非数值";
  ]

  (** 字符串处理相关 *)
  let string_processing = [
    "正则表达式"; "模式匹配"; "字符编码"; "Unicode";
  ]
