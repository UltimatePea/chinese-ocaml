        ...
        (fun group ->
          ...
          | TokenGroups.BasicKeywords token ->
              UnifiedTokenProcessor.log_processing_info
                (Base_formatter.concat_strings
                   [ "表达式解析: 基础关键字 "; Yyocamlc_lib.Lexer_tokens.show_token token ])
          | TokenGroups.WenyanKeywords token ->
              UnifiedTokenProcessor.log_processing_info
                (Base_formatter.concat_strings
                   [ "表达式解析: 文言文关键字 "; Yyocamlc_lib.Lexer_tokens.show_token token ])
          | TokenGroups.AncientKeywords token ->
              UnifiedTokenProcessor.log_processing_info
                (Base_formatter.concat_strings
                   [ "表达式解析: 古雅体关键字 "; Yyocamlc_lib.Lexer_tokens.show_token token ])
