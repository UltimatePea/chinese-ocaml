...
(** 性能优化的快速路径转换 *)
module FastPath : sig
  val convert_identifier_fast : Token_mapping.Token_definitions_unified.token -> Yyocamlc_lib.Lexer_tokens.token
  val convert_literal_fast : Token_mapping.Token_definitions_unified.token -> Yyocamlc_lib.Lexer_tokens.token
  val convert_keyword_fast : Token_mapping.Token_definitions_unified.token -> Yyocamlc_lib.Lexer_tokens.token
  val convert_type_fast : Token_mapping.Token_definitions_unified.token -> Yyocamlc_lib.Lexer_tokens.token
  val convert_classical_fast : Token_mapping.Token_definitions_unified.token -> Yyocamlc_lib.Lexer_tokens.token
end
