...
val map_legacy_literal_to_unified : string -> Yyocamlc_lib.Unified_token_core.unified_token option
(** 字面量映射 *)

val map_legacy_identifier_to_unified : string -> Yyocamlc_lib.Unified_token_core.unified_token option
(** 标识符映射 *)

val map_legacy_special_to_unified : string -> Yyocamlc_lib.Unified_token_core.unified_token option
(** 特殊Token映射 *)

val map_legacy_operator_to_unified : string -> Yyocamlc_lib.Unified_token_core.unified_token option
(** 运算符映射 *)
