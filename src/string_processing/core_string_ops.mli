...
(** [process_string_with_skip line skip_logic] 通用字符串处理模板，根据跳过逻辑处理字符串
    @param line 要处理的字符串
...
(** [block_comment_skip_logic i line len] 块注释跳过逻辑，处理 (* ... *) 注释 *)

val luoyan_string_skip_logic : int -> string -> int -> bool * int
(** [luoyan_string_skip_logic i line len] 骆言字符串跳过逻辑，处理中文字符串字面量 *)

val english_string_skip_logic : int -> string -> int -> bool * int
(** [english_string_skip_logic i line len] 英文字符串跳过逻辑，处理 "..." 和 '...' 字符串 *)

(** {1 注释处理函数} *)

val remove_double_slash_comment : string -> string
(** [remove_double_slash_comment line] 移除双斜杠注释 (//) *)

val remove_hash_comment : string -> string
(** [remove_hash_comment line] 移除井号注释 (#) *)

(** {1 重构后的字符串处理函数} *)

val remove_block_comments : string -> string
(** [remove_block_comments line] 移除块注释的快捷函数 *)

val remove_luoyan_strings : string -> string
(** [remove_luoyan_strings line] 移除骆言字符串的快捷函数 *)

val remove_english_strings : string -> string
(** [remove_english_strings line] 移除英文字符串的快捷函数 *)
