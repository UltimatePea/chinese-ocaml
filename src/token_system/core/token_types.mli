...
(** 语义增强关键字Token *)
type semantic_token = AsKeyword | CombineKeyword | WithOpKeyword | WhenKeyword
...
(** 宏系统关键字Token *)
type macro_system_token = MacroKeyword | ExpandKeyword
...
(** 特殊Token *)
type special_token = EOF | Newline | Whitespace of string | Comment of string
...
type positioned_token = { token : token; position : position; text : string }
(** 带位置信息的Token *)
