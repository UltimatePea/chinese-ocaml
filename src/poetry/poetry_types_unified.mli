...
(** 查询结果类型 *)
type query_result = Found of rhyme_entry | NotFound | Ambiguous of rhyme_entry list

type validation_result = { is_valid : bool; violations : string list; suggestions : string list }
(** 韵律验证结果 *)
...
val make_rhyme_group_data : rhyme_group -> string -> string list -> string list -> rhyme_group_data
(** 创建韵组数据 *)
