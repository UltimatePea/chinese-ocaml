...
val calculate_overall_grade :
  ...
  Poetry_core.Poetry_types.evaluation_grade
(** 计算整体等级
...
val create_evaluation_result :
  ...
  float * float * float * float * float * float ->
  string list ->
  Poetry_core.Poetry_types.artistic_report
(** 创建标准评价结果
...
val create_error_evaluation : string array -> string -> Poetry_core.Poetry_types.artistic_report
(** 创建错误评价结果
