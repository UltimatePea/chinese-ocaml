...
val find_rhyme_info : string -> (Poetry_core.Poetry_types.rhyme_category * Poetry_core.Poetry_types.rhyme_group) option
...
(** 分析诗句字符的韵律信息
    @param verse 诗句
    @return 字符韵律分析结果列表 *)
val analyze_verse_chars : string -> (char * Poetry_core.Poetry_types.rhyme_category * Poetry_core.Poetry_types.rhyme_group) list
...
(** 重导出构建辅助函数 *)
val make_entry : string -> Poetry_core.Poetry_types.rhyme_category -> Poetry_core.Poetry_types.rhyme_group -> ?variants:string list -> ?frequency:float -> unit -> rhyme_data_entry

val make_group_entries : Poetry_core.Poetry_types.rhyme_category -> Poetry_core.Poetry_types.rhyme_group -> string list -> rhyme_data_entry list
...
type rhyme_analysis_report = {
  ...
  char_analysis : (char * Poetry_core.Poetry_types.rhyme_category * Poetry_core.Poetry_types.rhyme_group) list;
}
...
(** 安全查找韵律信息 - 兼容性函数 *)
val safe_find_rhyme_info : string -> (Poetry_core.Poetry_types.rhyme_category * Poetry_core.Poetry_types.rhyme_group) option option

(** 查找字符韵律信息 - 兼容性函数 *)
val find_char_rhyme_info : string -> (Poetry_core.Poetry_types.rhyme_category * Poetry_core.Poetry_types.rhyme_group) option