...
let adjective_data = [
  ...
  (* 美丑好坏 *)
  ("好", Adjective); ("坏", Adjective); ("美", Adjective); ("丑", Adjective);
  ("亮", Adjective); ("暗", Adjective); ("明", Adjective); ("清", Adjective);
]

let other_data = [
  (* 数词 *)
  ("一", Numeral); ("二", Numeral); ("三", Numeral); ("四", Numeral); ("五", Numeral);
  ("六", Numeral); ("七", Numeral); ("八", Numeral); ("九", Numeral); ("十", Numeral);
  ...
  (* 介词 *)
  ("在", Preposition); ("于", Preposition); ("从", Preposition); ("到", Preposition);
  
  (* 连词 *)
  ("和", Conjunction); ("与", Conjunction); ("及", Conjunction); ("或", Conjunction);
  
  (* 助词 *)
  ("的", Particle); ("地", Particle); ("得", Particle); ("了", Particle);
  
  (* 叹词 *)
  ("啊", Interjection); ("哎", Interjection); ("哦", Interjection); ("嗯", Interjection);
]
