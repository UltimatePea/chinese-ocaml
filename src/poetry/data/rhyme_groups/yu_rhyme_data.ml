(** 鱼韵组数据模块 - 骆言诗词编程特性
    ...
    鱼书居虚，渔樵江渚意深远。鱼韵组包含"鱼、书、居、虚"等字符，
    依《平水韵》传统分类，音韵和谐，意境悠远，为诗词创作提供丰富的韵律选择。
...
(** 鱼韵组核心常用字
    ...
    包含最常用的鱼韵字符，如"鱼、书、居、虚"等。
    这些字符在诗词创作中使用频率较高，韵律感强。 *)
...
(** 鱼韵组棋期系列
    ...
    包含"棋、旗、期、欺"等字符，涵盖了期盼、奇特等语义，
    为诗词表达提供了丰富的情感色彩。 *)
let yu_yun_qi_chars =
  [
    "棋"; "旗"; "期"; "欺"; "漆";
    "齐"; "脐"; "奇"; "骑"; "其"; "祈"; "耆"; "鳍"; "麒"; "琪"; "畦";
    "犁"; "梨"; "离"; "厘"; "篱";
    "礼"; "里"; "理"; "李"; "荔";
    "立"; "力"; "历"; "厉"; "励";
    "猎"; "列"; "烈"; "裂"; "劣"; "蹩"; "别";
...
(** 鱼韵组扩展鱼类字符
    ...
    包含各种鱼类名称的生僻字符，主要用于扩展词汇量，
    为诗词创作提供更丰富的选择，特别适合写景抒情类作品。 *)
let yu_yun_fish_chars =
  [
    "鳙"; "鳚"; "鳛"; "鳜"; "鳝"; "鳞"; "鳟"; "鳠"; "鳡"; "鳢";
    "鳣"; "鳤"; "鳥"; "鳦"; "鳧"; "鳨"; "鳩"; "鳪"; "鳫"; "鳬"; "鳭";
  ]
...
(** 鱼韵组平声韵数据
    ...
    合并所有鱼韵组字符，生成完整的鱼韵平声韵数据。
    包含核心字符、贾价系列、棋期系列和扩展鱼类字符。
