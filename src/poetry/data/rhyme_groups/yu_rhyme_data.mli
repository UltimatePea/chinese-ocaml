...
(** 鱼韵组平声韵数据 (懒加载) *)
val yu_yun_ping_sheng : (string * Rhyme_group_types.rhyme_category * Rhyme_group_types.rhyme_group) list Lazy.t
...
module Compatibility : sig
  ...
  (** 立即获取平声韵数据 *)
  val get_yu_yun_ping_sheng : unit -> (string * Rhyme_group_types.rhyme_category * Rhyme_group_types.rhyme_group) list
