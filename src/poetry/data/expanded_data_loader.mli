...
(** 安全加载动词数据 - 返回元组包含所有动词分类
    @return
      ...
      emotional_expression, social_behavior, agricultural, manufacturing, transportation,
      commercial, cleaning) *)
...
val safe_load_adverbs :
  unit -> (string * word_class) list * (string * word_class) list * (string * word_class) list
