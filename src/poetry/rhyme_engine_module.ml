...
(** 分析文本的韵律模式 *)
let analyze_pattern text = Unified_rhyme_api.analyze_rhyme_pattern text

(** 评估韵律质量 *)
let evaluate_quality text = Unified_rhyme_api.evaluate_rhyme_quality text

(** 检测押韵方案 *)
let detect_scheme lines = Unified_rhyme_api.detect_poem_rhyme_scheme lines
