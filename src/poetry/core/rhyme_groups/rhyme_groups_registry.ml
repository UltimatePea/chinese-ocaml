...
(** 所有韵律数据的统一集合 *)
let all_rhyme_data =
  Rhyme_group_an.all_data @
  Rhyme_group_si.all_data @
  Rhyme_group_tian.all_data @
  Rhyme_group_wang.all_data @
  Rhyme_group_qu.all_data @
  Rhyme_group_yu.all_data @
  Rhyme_group_hua.all_data @
  Rhyme_group_feng.all_data @
  Rhyme_group_yue.all_data @
  Rhyme_group_jiang.all_data @
  Rhyme_group_hui.all_data
...
let data_by_category =
  let ping_sheng_data = 
    Rhyme_group_an.ping_sheng_data @
    Rhyme_group_si.ping_sheng_data @
    Rhyme_group_tian.ping_sheng_data @
    Rhyme_group_yu.ping_sheng_data @
    Rhyme_group_hua.ping_sheng_data @
    Rhyme_group_feng.ping_sheng_data @
    Rhyme_group_jiang.ping_sheng_data
  in
  let ze_sheng_data =
    Rhyme_group_an.ze_sheng_data @
    Rhyme_group_si.ze_sheng_data @
    Rhyme_group_wang.ze_sheng_data @
    Rhyme_group_yue.ze_sheng_data @
    Rhyme_group_hui.ze_sheng_data
  in
  let qu_sheng_data = Rhyme_group_qu.qu_sheng_data in
  [
    (PingSheng, ping_sheng_data);
    (ZeSheng, ze_sheng_data);
    (QuSheng, qu_sheng_data);
  ]
...
let char_count_by_category =
  let ping_count = List.fold_left (+) 0 [
