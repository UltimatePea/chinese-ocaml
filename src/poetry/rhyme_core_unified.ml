(** 韵律数据统一核心模块 - 骆言诗词编程特性
    ...
    整合来自 rhyme_core_data_original.ml、所有韵组数据文件、unified_rhyme_data.ml 等模块。
...
let an_rhyme_data = 
  let ping_sheng_chars = [
    ...
    "面"; "见"; "片"; "编"; "眠"; "蟾"; "贤"; "田"; "填"; "肩"; "坚";
  ] in
  let ze_sheng_chars = [
    "看"; "叹"; "散"; "慢"; "管"; "段"; "短"; "断"; "半"; "满"; "汗"; "寒";
    "卷"; "算"; "乱"; "暖"; "换"; "幻"; "善"; "骗"; "转"; "软"; "选";
  ] in
  {
    group_name = AnRhyme;
    group_description = "安韵组 - 含山、间、闲等字，音韵和谐";
    entries = (make_group_entries PingSheng AnRhyme ping_sheng_chars) @
...
let si_rhyme_data =
  let ping_sheng_chars = [
    "思"; "丝"; "时"; "持"; "支"; "春"; "人"; "真"; "因"; "新"; "心"; "深";
    "林"; "金"; "寻"; "音"; "吟"; "今"; "临"; "琴"; "禁"; "森"; "参"; "淋";
    "任"; "沈"; "阴"; "侵"; "针"; "怀"; "来"; "开"; "台"; "回"; "才"; "材";
  ] in
  let ze_sheng_chars = [
    "是"; "此"; "里"; "子"; "止"; "起"; "已"; "士"; "市"; "史"; "死"; "使";
    "始"; "似"; "致"; "至"; "治"; "智"; "志"; "字"; "次"; "事"; "诗"; "师";
  ] in
  {
    group_name = SiRhyme;
    group_description = "思韵组 - 含时、诗、知等字，情思绵绵";
    entries = (make_group_entries PingSheng SiRhyme ping_sheng_chars) @
...
let tian_rhyme_data =
  let ping_sheng_chars = [
    ...
    "便"; "面"; "见"; "片"; "编"; "眠"; "蟾"; "贤"; "填"; "肩"; "传"; "船";
    "川"; "泉"; "弦"; "烟"; "燕"; "县"; "仙"; "鲜"; "绵"; "延"; "颠"; "牵";
  ] in
  let ze_sheng_chars = [
    "变"; "电"; "片"; "店"; "点"; "念"; "见"; "现"; "线"; "显"; "典"; "殿";
    "遍"; "便"; "面"; "箭"; "剑"; "件"; "建"; "健"; "键"; "练"; "炼"; "链";
  ] in
  {
    group_name = TianRhyme;
    group_description = "天韵组 - 含年、先、田等字，天籁之音";
    entries = (make_group_entries PingSheng TianRhyme ping_sheng_chars) @
...
let wang_rhyme_data =
  let ze_sheng_chars = [
    "望"; "放"; "向"; "响"; "亮"; "唱"; "忘"; "想"; "上"; "当"; "长"; "张";
    "房"; "方"; "旁"; "傍"; "堂"; "塘"; "墙"; "强"; "光"; "广"; "网"; "状";
    "样"; "量"; "场"; "常"; "床"; "窗"; "双"; "霜"; "创"; "装"; "藏"; "浪";
  ] in
  {
...
let qu_rhyme_data =
  let ze_sheng_chars = [
    "去"; "路"; "度"; "步"; "府"; "故"; "住"; "处"; "数"; "素"; "布"; "户";
    "古"; "土"; "苦"; "库"; "护"; "互"; "注"; "助"; "著"; "部"; "图"; "途";
    "树"; "书"; "鼠"; "暑"; "绪"; "序"; "叙"; "述"; "术"; "束"; "属"; "竹";
  ] in
  {
    group_name = QuRhyme;
...
let yu_rhyme_data =
  let ping_sheng_chars = [
    "鱼"; "书"; "余"; "居"; "如"; "初"; "渠"; "车"; "花"; "家"; "华"; "加";
    "嘉"; "茶"; "沙"; "纱"; "牙"; "芽"; "霞"; "瓜"; "蛙"; "娃"; "画"; "话";
    "化"; "划"; "马"; "下"; "夏"; "价"; "架"; "假"; "货"; "火"; "果"; "过";
  ] in
  {
    group_name = YuRhyme;
...
let hua_rhyme_data =
  let ping_sheng_chars = [
    "花"; "华"; "家"; "加"; "嘉"; "茶"; "沙"; "纱"; "牙"; "芽"; "霞"; "瓜";
    "蛙"; "娃"; "画"; "话"; "化"; "划"; "马"; "下"; "夏"; "价"; "架"; "假";
  ] in
  let ze_sheng_chars = [
    "化"; "话"; "画"; "划"; "价"; "架"; "假"; "货"; "火"; "果"; "过"; "坐";
    "座"; "作"; "做"; "破"; "播"; "课"; "可"; "河"; "何"; "哥"; "歌"; "多";
  ] in
  {
    group_name = HuaRhyme;
    group_description = "花韵组 - 含花、霞、家等字，春花秋月";
    entries = (make_group_entries PingSheng HuaRhyme ping_sheng_chars) @
...
let feng_rhyme_data =
  let ping_sheng_chars = [
    "风"; "中"; "空"; "东"; "红"; "虫"; "冲"; "从"; "重"; "宫"; "公"; "功";
    "工"; "弓"; "穷"; "终"; "钟"; "雄"; "熊"; "充"; "松"; "送"; "通"; "同";
    "童"; "桐"; "铜"; "朋"; "蓬"; "鹏"; "陇"; "隆"; "龙"; "浓"; "农"; "绒";
  ] in
  let ze_sheng_chars = [
    "送"; "用"; "动"; "众"; "重"; "种"; "总"; "宗"; "综"; "纵"; "从"; "冲";
    "统"; "痛"; "通"; "同"; "童"; "桐"; "铜"; "筒"; "控"; "空"; "孔"; "洞";
  ] in
  {
    group_name = FengRhyme;
    group_description = "风韵组 - 含风、送、中等字，秋风萧瑟";
    entries = (make_group_entries PingSheng FengRhyme ping_sheng_chars) @
...
let yue_rhyme_data =
  let ze_sheng_chars = [
    ...
    "列"; "烈"; "裂"; "灭"; "结"; "洁"; "接"; "街"; "解"; "界"; "借"; "介";
    "戒"; "届"; "疥"; "芥"; "械"; "懈"; "谢"; "楔"; "泄"; "屑"; "咽"; "噎";
  ] in
  {
    group_name = YueRhyme;
...
let jiang_rhyme_data =
  let ping_sheng_chars = [
    "江"; "窗"; "双"; "霜"; "创"; "装"; "藏"; "浪"; "郎"; "狼"; "廊"; "朗";
    "忙"; "茫"; "忘"; "芒"; "亡"; "王"; "往"; "网"; "望"; "旺"; "汪"; "妄";
  ] in
  let ze_sheng_chars = [
    "唱"; "创"; "装"; "藏"; "浪"; "郎"; "狼"; "廊"; "朗"; "忙"; "茫"; "忘";
    "芒"; "亡"; "王"; "往"; "网"; "望"; "旺"; "汪"; "妄"; "放"; "方"; "房";
  ] in
  {
    group_name = JiangRhyme;
    group_description = "江韵组 - 含江、窗、双等字，大江东去";
    entries = (make_group_entries PingSheng JiangRhyme ping_sheng_chars) @
...
let hui_rhyme_data =
  let ping_sheng_chars = [
    "灰"; "回"; "推"; "胎"; "台"; "来"; "开"; "才"; "材"; "财"; "裁"; "哀";
    "崖"; "涯"; "牌"; "排"; "培"; "陪"; "赔"; "杯"; "悲"; "北"; "备"; "被";
  ] in
  let ze_sheng_chars = [
    "改"; "海"; "害"; "亥"; "代"; "带"; "待"; "黛"; "呆"; "袋"; "贷"; "逮";
    "态"; "太"; "泰"; "汰"; "肽"; "钛"; "苔"; "抬"; "胎"; "台"; "怠"; "殆";
  ] in
  {
    group_name = HuiRhyme;
    group_description = "灰韵组 - 含灰、回、推等字，灰飞烟灭";
    entries = (make_group_entries PingSheng HuiRhyme ping_sheng_chars) @
...
let get_statistics () =
  ...
  Printf.sprintf 
    "韵律数据统计: 总计 %d 个字符，%d 个韵组，平声 %d 字，仄声 %d 字"
    total_entries total_groups ping_sheng_count ze_sheng_count
