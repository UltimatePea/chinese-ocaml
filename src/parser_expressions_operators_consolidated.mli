...
val create_operator_precedence_chain : 
  (parser_state -> expr * parser_state) ->
  ((parser_state -> expr * parser_state) *   (* parse_expression *)
   (parser_state -> expr * parser_state) *   (* parse_or_else_expr *)
   (parser_state -> expr * parser_state) *   (* parse_or_expr *)
   (parser_state -> expr * parser_state) *   (* parse_and_expr *)
   (parser_state -> expr * parser_state) *   (* parse_comparison_expr *)
   (parser_state -> expr * parser_state) *   (* parse_arithmetic_expr *)
   (parser_state -> expr * parser_state) *   (* parse_multiplicative_expr *)
   (parser_state -> expr * parser_state))    (* parse_unary_expr *)
