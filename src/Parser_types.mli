...
(** 解析变体标签 *)
val parse_variant_labels : parser_state -> (string * type_expr option) list -> (string * type_expr option) list * parser_state
...
(** 解析变体构造器列表 *)
val parse_variant_constructors : parser_state -> (string * type_expr option) list -> type_def * parser_state
...
(** 解析签名项列表 *)
val parse_signature_items : signature_item list -> parser_state -> signature_item list * parser_state
