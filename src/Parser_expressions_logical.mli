...
(** 解析逻辑或表达式 *)
val parse_logical_or_expression : (parser_state -> expr * parser_state) -> parser_state -> expr * parser_state

(** 解析逻辑与表达式 *)
val parse_logical_and_expression : (parser_state -> expr * parser_state) -> parser_state -> expr * parser_state
