...
module PoetryBenchmark = struct
  ...
  let get_poetry_test_configs () = [
    { 
      Benchmark_core.name = "短诗韵律分析"; 
      iterations = 30; 
      data_size = 2; 
      description = "短诗测试" 
    };
    { 
      Benchmark_core.name = "长诗韵律分析"; 
      iterations = 10; 
      data_size = 10; 
      description = "长诗测试" 
    };
    { 
      Benchmark_core.name = "古典诗集分析"; 
      iterations = 5; 
      data_size = 50; 
      description = "大型诗集测试" 
    };
  ...
  let run_poetry_feature_benchmark () =
    let poetry_feature_configs = [
      {
        Benchmark_core.name = "诗词韵律检测";
        iterations = 50;
        data_size = 4;
        description = "韵律分析测试";
      };
      {
        Benchmark_core.name = "诗词情感分析";
        iterations = 30;
        data_size = 8;
        description = "情感识别测试";
      };
      {
        Benchmark_core.name = "诗词格律校验";
        iterations = 20;
        data_size = 12;
        description = "格律验证测试";
      };
