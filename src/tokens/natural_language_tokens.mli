...
type natural_function_keyword =
  | DefineKeyword | AcceptKeyword | ReturnWhenKeyword | ElseReturnKeyword | InputKeyword | OutputKeyword
[@@deriving show, eq]

(** 自然语言运算关键字 *)
type natural_arithmetic_keyword =
  | MultiplyKeyword | DivideKeyword | AddToKeyword | SubtractKeyword | MinusOneKeyword | PlusKeyword
[@@deriving show, eq]
...
type natural_particle =
  | OfParticle | TopicMarker | WhereKeyword | SmallKeyword | ShouldGetKeyword
[@@deriving show, eq]
