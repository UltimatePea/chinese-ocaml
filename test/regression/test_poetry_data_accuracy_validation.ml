(** * Poetry数据准确性验证测试 - Issue #1746响应 * Author: Echo, 测试工程师代理 * * 此测试专门验证PR #1745中数据声明的准确性， *
...
let () =
  ...
  run "Poetry Data Accuracy Validation" [ ("Data Accuracy and Consistency", data_accuracy_tests) ]
