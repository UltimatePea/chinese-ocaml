...
let test_filter_ly_files_function () =
  (* 测试包含.ly文件的列表 *)
  let file_list = create_test_list [
  ...
  (* 测试不包含.ly文件的列表 *)
  let no_ly_list = create_test_list [
...
let test_filter_ly_files_edge_cases () =
  (* 测试文件名长度不足3的情况 *)
  let short_name_list = create_test_list [
    create_test_string "a.ly";
    create_test_string "ab";
  ...
  (* 测试包含非字符串元素的列表 *)
  let mixed_list = create_test_list [
...
let test_utility_functions_table () =
  ...
  let expected_functions = [
    "过滤ly文件"; "移除井号注释"; "移除双斜杠注释"; 
    "移除块注释"; "移除骆言字符串"; "移除英文字符串"
  ] in
...
let test_file_type_detection () =
  (* 测试各种文件扩展名 *)
  let mixed_files = create_test_list [
    create_test_string "program.ly";
    create_test_string "test.LY";  (* 大写扩展名 *)
    create_test_string "file.ly.backup";  (* 多重扩展名 *)
    create_test_string "lyfile";  (* 无扩展名但包含ly *)
    create_test_string ".ly";  (* 隐藏文件 *)
