...
let test_artistic_dimensions () =
  ...
  test_assert "韵律和谐维度定义正确" (rhyme_harmony = Yyocamlc_lib.Poetry_core.Poetry_types.RhymeHarmony);

  (* 测试声调平衡维度 *)
  let tonal_balance = Yyocamlc_lib.Poetry_core.Poetry_types.TonalBalance in
  test_assert "声调平衡维度定义正确" (tonal_balance = Yyocamlc_lib.Poetry_core.Poetry_types.TonalBalance);
...
let test_rhyme_quality_assessment () =
  ...
  let test_report =
    {
      ...
      rhyme_group = Yyocamlc_lib.Poetry_core.Poetry_types.TianRhyme;
      rhyme_category = Yyocamlc_lib.Poetry_core.Poetry_types.PingSheng;
      char_analysis =
        [
          (chun_char, Yyocamlc_lib.Poetry_core.Poetry_types.PingSheng, Yyocamlc_lib.Poetry_core.Poetry_types.TianRhyme);
          (mian_char, Yyocamlc_lib.Poetry_core.Poetry_types.PingSheng, Yyocamlc_lib.Poetry_core.Poetry_types.TianRhyme);
        ];
    }
  in
  ...
  test_assert "韵律报告韵组正确" (test_report.rhyme_group = Yyocamlc_lib.Poetry_core.Poetry_types.TianRhyme);
  ...
  let test_analysis =
    {
      ...
      overall_rhyme_groups =
        [ Yyocamlc_lib.Poetry_core.Poetry_types.TianRhyme; Yyocamlc_lib.Poetry_core.Poetry_types.YueRhyme ];
      overall_rhyme_categories =
        [ Yyocamlc_lib.Poetry_core.Poetry_types.PingSheng; Yyocamlc_lib.Poetry_core.Poetry_types.ZeSheng ];
