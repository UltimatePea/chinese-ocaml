(** 骆言C代码生成器操作表达式模块综合测试
    涵盖算术运算、逻辑运算、内存操作的全面测试 - Fix #1015 Phase 4 *)
...
let complex_tests = [
  test_case "嵌套二元运算测试" `Quick test_nested_binary_operations;
]
