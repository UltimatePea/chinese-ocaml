...
let test_source_manager () =
  ...
  (match
     Source_manager.register_data_source source_id test_loader ~priority:1 "Test data source"
   with
...
let test_performance () =
  ...
  Source_manager.clear_all_sources ();
  let _ =
    Source_manager.register_data_source (RhymeData "large_test") large_loader "Large test data"
  in
