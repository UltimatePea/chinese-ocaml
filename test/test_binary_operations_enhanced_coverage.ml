...
let test_string_comparison () =
  (* 相等比较 *)
  check_result "字符串相等真" (bool_val true) (execute_binary_op Eq (string_val "hello") (string_val "hello"));
  check_result "字符串相等假" (bool_val false) (execute_binary_op Eq (string_val "hello") (string_val "world"));
  
  (* 不等比较 *)
  check_result "字符串不等真" (bool_val true) (execute_binary_op Neq (string_val "hello") (string_val "world"));
  check_result "字符串不等假" (bool_val false) (execute_binary_op Neq (string_val "hello") (string_val "hello"));
...
let test_logical_operations () =
  ...
  (* 字符串逻辑运算 *)
  check_result "字符串And运算" (bool_val true) (execute_binary_op And (string_val "hello") (string_val "world"));
  check_result "空字符串And运算" (bool_val false) (execute_binary_op And (string_val "") (string_val "world"))
...
let test_mixed_type_comparison () =
  ...
  check_result "字符串与布尔不等" (bool_val false) (execute_binary_op Eq (string_val "true") (bool_val true));
...
let test_boundary_conditions () =
  ...
  (* 特殊浮点值 *)
  check_result "浮点无穷大相等" (bool_val true) (execute_binary_op Eq (float_val infinity) (float_val infinity));
  check_result "浮点负无穷大相等" (bool_val true) (execute_binary_op Eq (float_val neg_infinity) (float_val neg_infinity));
...
let test_performance_cases () =
  ...
  check_result "大数值加法" (int_val (2 * large_int)) 
    (execute_binary_op Add (int_val large_int) (int_val large_int));
  check_result "大数值乘法" (int_val (large_int * large_int)) 
