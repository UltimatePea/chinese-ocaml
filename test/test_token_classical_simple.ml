(** 简化的Token古典语言转换Phase 4.2测试 - Issue #1336
    ...
    验证重构后的核心功能： 1. 策略模式正确工作 2. 向后兼容性保持 3. 基本错误处理
...
let test_backward_compatibility () =
  ...
  try
    ...
    if
      result1 = TO.HaveKeyword && result2 = TO.DefineKeyword && result3 = TO.AncientDefineKeyword
      && result4 = TO.HaveKeyword && result5 = TO.DefineKeyword && result6 = TO.AncientDefineKeyword
    then (
