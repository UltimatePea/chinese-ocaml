...
let test_lexical_error_types () =
  ...
  [
    "invalid character error", `Quick, (fun () ->
    ...
    "unterminated string error", `Quick, (fun () ->
    ...
    "invalid number error", `Quick, (fun () ->
...
let test_parse_error_types () =
  ...
  [
    ...
    "missing expression error", `Quick, (fun () ->
...
let test_runtime_error_types () =
  ...
  [
    ...
    "index out of bounds error", `Quick, (fun () ->
...
let test_poetry_error_types () =
  ...
  [
    "invalid rhyme pattern error", `Quick, (fun () ->
    ...
    "invalid verse structure error", `Quick, (fun () ->
