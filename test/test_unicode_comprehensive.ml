(** LuoYan Compiler Unicode Module Comprehensive Test 
    For issue #749 test coverage improvement: Unicode processing module tests *)
...
let test_utf8_byte_sequences () =
  ...
  check bool "utf8_string_length" true ((String.length utf8_test_string) = 6); (* 2 Chinese chars = 6 bytes *)
...
let () = run "Unicode Module Comprehensive Test" [("Unicode Module Comprehensive Test", test_suite)]