...
夫「加3」者受 x 焉算法乃 答 x + 3 是谓;
夫「乘2」者受 x 焉算法乃 答 x * 2 是谓;
设「复合函数」为组合函数 乘2 加3;
设「组合结果」为复合函数 5;
...
让「平方列表」=映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓） [1; 2; 3; 4; 5];
打印 （『平方映射[1;2;3;4;5]=』 + 列表转字符串 平方列表）;

让「偶数列表」=过滤 （夫「匿名」者受 x 焉算法乃 答 x % 2=0 是谓） 数字列表;
打印 （『过滤偶数=』 + 列表转字符串 偶数列表）;

让「求和」=折叠左 （夫「匿名」者受 acc x 焉算法乃 答 acc + x 是谓） 0 [1; 2; 3; 4; 5];
...
夫「数据处理管道」者受 数据 焉算法乃
  答 数据
  |> 映射 （夫「匿名」者受 x 焉算法乃 答 x * 2 是谓）      「：每个元素乘2：」
  |> 过滤 （夫「匿名」者受 x 焉算法乃 答 x > 10 是谓）     「：过滤大于10的：」
  |> 映射 （夫「匿名」者受 x 焉算法乃 答 x + 1 是谓）      「：每个元素加1：」
  |> 折叠左 （夫「匿名」者受 acc x 焉算法乃 答 acc + x 是谓） 0 是谓; 「：求和：」
...
夫「计算因子」者受 n 焉算法乃
  答 范围 1 n
  |> 过滤 （夫「匿名」者受 i 焉算法乃 答 n % i=0 是谓） 是谓;
...
递归夫「帕斯卡行」者受 n 焉算法乃
  ...
  余者
    ...
    让「左移」=[0; ...上一行] 在
    让「右移」=上一行 @ [0] 在
    答 映射2 （夫「匿名」者受 a b 焉算法乃 答 a + b 是谓） 左移 右移 是谓;
