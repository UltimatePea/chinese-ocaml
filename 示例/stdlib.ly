...
模块 数学={
  ...
  语句: (列开始 递归夫「阶乘」者受 n 焉算法乃
      若 n <=1 则 答 1 余者答 n * 阶乘 （n - 1） 也 其一 递归夫「斐波那契」者受 n 焉算法乃
      观「n」之性
      | 0 -> 答 0
      | 1 -> 答 1
      | _ -> 答 斐波那契 （n - 1） + 斐波那契 （n - 2）
      观毕也 其二 夫「最大值」者受 x y 焉算法乃
      若 x > y 则 答 x 余者答 y 也 其三 夫「最小值」者受 x y 焉算法乃
      若 x < y 则 答 x 余者答 y 也 其一 列结束);
}
