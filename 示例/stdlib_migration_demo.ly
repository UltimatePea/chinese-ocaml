...
设「平方数据」为映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓） 数据;
打印 （『平方后: 』 + 列表转字符串 平方数据）;

设「偶数数据」为过滤 （夫「匿名」者受 x 焉算法乃 答 x % 2=0 是谓） 数据;
打印 （『偶数: 』 + 列表转字符串 偶数数据）;
...
设「新平方数据」为映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓） 新数据;
打印行 （『标准库平方映射: 』 + 列表转字符串 新平方数据）;

设「新偶数数据」为过滤 （夫「匿名」者受 x 焉算法乃 答 x % 2=0 是谓） 新数据;
打印行 （『标准库过滤偶数: 』 + 列表转字符串 新偶数数据）;

「：使用标准库的高级功能：」
设「数据求和」为折叠左 （夫「匿名」者受 acc x 焉算法乃 答 acc + x 是谓） 0 新数据;
...
夫「加倍」者受 x 焉算法乃 答 x * 2 是谓;
夫「加一」者受 x 焉算法乃 答 x + 1 是谓;
设「复合操作」为组合函数 加倍 加一;
...
夫「数据处理管道」者受 输入数据 焉算法乃
  输入数据
  |> 过滤 （夫「匿名」者受 x 焉算法乃 答 x > 3 是谓）     「：过滤大于3的数：」
  |> 映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓）     「：平方：」
  |> 映射 （夫「匿名」者受 x 焉算法乃 答 x + 1 是谓）     「：加1：」
  |> 折叠左 （夫「匿名」者受 acc x 焉算法乃 答 最大值 acc x 是谓） 0 是谓; 「：找最大值：」
...
「：内置函数版本：」
让「开始时间1」=获取当前时间 （）;
设「内置结果」为映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓） 大数据集;
让「结束时间1」=获取当前时间 （）;
让「内置耗时」=结束时间1 - 开始时间1;
...
「：标准库版本：」
让「开始时间2」=获取当前时间 （）;
设「标准库结果」为映射 （夫「匿名」者受 x 焉算法乃 答 x * x 是谓） 大数据集;
让「结束时间2」=获取当前时间 （）;
让「标准库耗时」=结束时间2 - 开始时间2;
...
夫「列表转字符串」者受 lst 焉算法乃
  答 『(列开始 』 + （连接列表 『 其一 』 （映射 整数转字符串 lst）） + 『 其二 列结束)』 是谓;
