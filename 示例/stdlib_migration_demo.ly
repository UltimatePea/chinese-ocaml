...
设「偶数数据」为过滤 （夫「匿名」者受 甲 焉算法乃 答 甲 除余 2=0 也） 数据;
打印 （『偶数: 』 加 列表转字符串 偶数数据）;
...
设「新偶数数据」为过滤 （夫「匿名」者受 甲 焉算法乃 答 甲 除余 2=0 也） 新数据;
...
夫「数据处理管道」者受 输入数据 焉算法乃
  输入数据
  |> 过滤 （夫「匿名」者受 甲 焉算法乃 答 甲 大于 3 也）     「：过滤大于3的数：」
  |> 映射 （夫「匿名」者受 甲 焉算法乃 答 甲 乘 甲 也）     「：平方：」
  |> 映射 （夫「匿名」者受 甲 焉算法乃 答 甲 加 1 也）     「：加1：」
  |> 折叠左 （夫「匿名」者受 累 甲 焉算法乃 答 最大值 累 甲 也） 0 也; 「：找最大值：」
...
夫「创建标题」者受 文本 焉算法乃
  让「分隔线」=重复 （长度 文本 加 4） 『=』 在
  答 连接 分隔线 （连接 『\数| 』 （连接 文本 （连接 『 |\数』 分隔线））） 也;
...
打印行 『• 网络模块 减 HTTP和TCP/UDP』;
打印行 『• 正则表达式模块 减 模式匹配』;
打印行 『• 并发模块 减 异步和并行处理』;
打印行 『• 序列化模块 减 JSON/XML处理』;
