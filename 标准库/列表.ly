...
模块 列表={
  ...
  语句: [
    ...
    递归夫「范围」者受 开始 结束 焉算法乃
      若 开始 > 结束 则 答 []
      余者答 [开始; ...范围 （开始 + 1） 结束] 是谓;
    
    递归夫「重复」者受 次数 值 焉算法乃
      若 次数 <=0 则 答 []
      余者答 [值; ...重复 （次数 - 1） 值] 是谓;
    
    递归夫「取前n个」者受 n lst 焉算法乃
      若 n <=0 则 答 []
      余者
        观「lst」之性
        若 [] 则 答 []
