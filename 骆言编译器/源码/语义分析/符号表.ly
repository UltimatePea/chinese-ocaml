...
「：创建符号表：」
夫 创建符号表 者 受 错误收集器 焉 算法 乃
  设 全局作用域 为 创建作用域 无 0 在
  {
    当前作用域 = 全局作用域;
    全局作用域 = 全局作用域;
    错误收集器 = 错误收集器;
...
「：进入新作用域：」
夫 进入作用域 者 受 符号表 焉 算法 乃
  设 新级别 为 符号表.当前作用域.作用域级别 + 1 在
  设 新作用域 为 创建作用域 (有 符号表.当前作用域) 新级别 在
  符号表.当前作用域 := 新作用域
是谓

「：退出当前作用域：」
夫 退出作用域 者 受 符号表 焉 算法 乃
  观 符号表.当前作用域.父作用域 之 性
  | 无 -> 
      添加编译错误 符号表.错误收集器
...
「：创建符号绑定：」
夫 创建符号绑定 者 受 名称 符号类型 位置 可变 焉 算法 乃
  {
    名称 = 名称;
    符号类型 = 符号类型;
    定义位置 = 位置;
...
「：在当前作用域中绑定符号：」
夫 绑定符号 者 受 符号表 名称 符号类型 位置 可变 焉 算法 乃
  若 字典包含键 符号表.当前作用域.绑定表 名称 则 答 (
    添加编译错误 符号表.错误收集器
      (语义错误 (『符号 '』 ^ 名称 ^ 『' 已在当前作用域中定义』, 位置));
    false
  ) 余者 答 (
    设 绑定 为 创建符号绑定 名称 符号类型 位置 可变 在
...
「：查找符号，如果不存在则报错：」
夫 查找符号或报错 者 受 符号表 名称 位置 焉 算法 乃
  观 查找符号 符号表 名称 之 性
  | 有 绑定 -> 有 绑定
  | 无 ->
      添加编译错误 符号表.错误收集器
...
「：检查符号是否可变：」
夫 符号是否可变 者 受 绑定 焉 算法 乃
  绑定.可变
是谓

「：获取符号类型：」
夫 获取符号类型 者 受 绑定 焉 算法 乃
  绑定.符号类型
是谓

「：获取符号定义位置：」
夫 获取符号位置 者 受 绑定 焉 算法 乃
  绑定.定义位置
是谓

「：列出当前作用域中的所有符号：」
夫 列出当前作用域符号 者 受 符号表 焉 算法 乃
  字典键列表 符号表.当前作用域.绑定表
是谓

「：获取当前作用域级别：」
夫 获取作用域级别 者 受 符号表 焉 算法 乃
  符号表.当前作用域.作用域级别
是谓

「：是否在全局作用域：」
夫 在全局作用域 者 受 符号表 焉 算法 乃
  符号表.当前作用域.作用域级别 = 0
是谓

「：初始化全局符号表（预定义符号）：」
夫 初始化全局符号 者 受 符号表 焉 算法 乃
  设 位置 为 创建初始位置 『<内置>』 在
...
「：调试：打印作用域信息：」
夫 调试打印作用域 者 受 符号表 焉 算法 乃
  设 递归 打印作用域 为 函数 作用域 缩进 ->
    打印字符串 (缩进 ^ 『作用域级别: 』 ^ (字符串化整数 作用域.作用域级别));
    打印换行 ();
    设 符号列表 为 字典键列表 作用域.绑定表 在
    List.iter (函数 名称 ->
      设 绑定 为 字典获取 作用域.绑定表 名称 在
      打印字符串 (缩进 ^ 『  』 ^ 名称 ^ 『: 』);
      观 绑定.符号类型 之 性
