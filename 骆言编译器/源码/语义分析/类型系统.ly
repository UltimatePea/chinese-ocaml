...
且有 类型包含变量 者 受 类型 变量 焉算法乃
  ...
  | 元组类型 类型列表 ->
      List.exists （夫「_」者受 类型 焉算法乃 类型包含变量 类型 变量 是谓） 类型列表
  | 列表类型 元素类型 ->
      类型包含变量 元素类型 变量
  | 记录类型 字段列表 ->
      List.exists （夫「_」者受 （_, 类型） 焉算法乃 类型包含变量 类型 变量 是谓） 字段列表
  | 变体类型 （_, 参数类型列表） ->
      List.exists （夫「_」者受 类型 焉算法乃 类型包含变量 类型 变量 是谓） 参数类型列表
  | 引用类型 内容类型 ->
      类型包含变量 内容类型 变量
  | 数组类型 元素类型 ->
      类型包含变量 元素类型 变量
...
且有 格式化类型 者 受 类型 焉算法乃
  ...
  | 变体类型 （名称, 参数类型列表） ->
      名称 ^ （若 参数类型列表=空空如也 则 答 『』 
              余者答 『 （』 ^ （字符串连接 『 * 』 （List.map 格式化类型 参数类型列表）） ^ 『）』）
  | 引用类型 内容类型 ->
      （格式化类型 内容类型） ^ 『 引用』
  | 数组类型 元素类型 ->
      （格式化类型 元素类型） ^ 『 数组』
