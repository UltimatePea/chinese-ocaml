...
夫 递归 类型相等 者 受 类型1 类型2 焉算法乃
  ...
  或 （元组类型 类型列表1， 元组类型 类型列表2） 减大于
      列表点长度 类型列表1等于列表点长度 类型列表2 和和
      列表点循环all2 类型相等 类型列表1 类型列表2
...
夫 递归 统一类型 者 受 环境 类型1 类型2 焉算法乃
  ...
  余者答
    ...
    或 （函数类型 （参数1， 返回1）， 函数类型 （参数2， 返回2）） 减大于
        ...
        观毕
    或 （元组类型 类型列表1， 元组类型 类型列表2） 减大于
        若 列表点长度 类型列表1 小于大于 列表点长度 类型列表2 则 答
          错误 （『元组长度不匹配』）
        余者答
...
且有 类型包含变量 者 受 类型 变量 焉算法乃
  ...
  或 元组类型 类型列表 减大于
      列表点存在 （夫「下划线」者受 类型 焉算法乃 类型包含变量 类型 变量 也） 类型列表
  或 列表类型 元素类型 减大于
      类型包含变量 元素类型 变量
  或 记录类型 字段列表 减大于
      列表点存在 （夫「下划线」者受 （下划线， 类型） 焉算法乃 类型包含变量 类型 变量 也） 字段列表
  或 变体类型 （下划线， 参数类型列表） 减大于
      列表点存在 （夫「下划线」者受 类型 焉算法乃 类型包含变量 类型 变量 也） 参数类型列表
  或 引用类型 内容类型 减大于
      类型包含变量 内容类型 变量
  或 数组类型 元素类型 减大于
      类型包含变量 元素类型 变量
...
且有 格式化类型 者 受 类型 焉算法乃
  ...
  或 元组类型 类型列表 减大于
      『（』 乘方 （字符串连接 『 乘 』 （列表点映射 格式化类型 类型列表）） 乘方 『）』
  或 列表类型 元素类型 减大于
      （格式化类型 元素类型） 乘方 『 列表』
  或 记录类型 字段列表 减大于
      『「 』 乘方 （字符串连接 『； 』 （列表点映射 （夫「下划线」者受 （名称， 类型） 焉算法乃
        名称 乘方 『： 』 乘方 （格式化类型 类型） 也） 字段列表）） 乘方 『 」』
  或 变体类型 （名称， 参数类型列表） 减大于
      名称 乘方 （若 参数类型列表等于空空如也 则 答 『』
              余者答 『 （』 乘方 （字符串连接 『 乘 』 （列表点映射 格式化类型 参数类型列表）） 乘方 『）』）
  或 引用类型 内容类型 减大于
      （格式化类型 内容类型） 乘方 『 引用』
  或 数组类型 元素类型 减大于
      （格式化类型 元素类型） 乘方 『 数组』
...
夫 递归 类型表达式到内部类型 者 受 环境 类型表达式 焉算法乃
  ...
  或 函数类型 （参数类型， 返回类型， 下划线） 减大于
      ...
      函数类型 （参数， 返回）
  或 元组类型 （类型列表， 下划线） 减大于
      设「内部类型列表」为列表点映射 （类型表达式到内部类型 环境） 类型列表 在
      元组类型 内部类型列表
  或 列表类型 （元素类型， 下划线） 减大于
      设「元素」为类型表达式到内部类型 环境 元素类型 在
      列表类型 元素
  或 记录类型 （字段列表， 下划线） 减大于
      设「内部字段列表」为列表点映射 （夫「下划线」者受 （名称， 类型） 焉算法乃
        （名称， 类型表达式到内部类型 环境 类型） 也） 字段列表 在
      记录类型 内部字段列表
  或 变体类型 （名称， 参数类型列表， 下划线） 减大于
      设「内部参数类型列表」为列表点映射 （类型表达式到内部类型 环境） 参数类型列表 在
      变体类型 （名称， 内部参数类型列表）
  或 引用类型 （内容类型， 下划线） 减大于
