...
类型 内部类型=  | 基础类型 的 字符串
  ...
  | 元组类型 的 内部类型 列表
  | 列表类型 的 内部类型
  | 记录类型 的 （字符串 乘 内部类型） 列表
  | 变体类型 的 字符串 乘 内部类型 列表
  | 引用类型 的 内部类型
  | 数组类型 的 内部类型
...
且有 类型包含变量 者 受 类型 变量 焉算法乃
  ...
  | 元组类型 类型列表 ->
      List.exists （夫「_」者受 类型 焉算法乃 类型包含变量 类型 变量 也） 类型列表
  | 列表类型 元素类型 ->
      类型包含变量 元素类型 变量
  | 记录类型 字段列表 ->
      List.exists （夫「_」者受 （_, 类型） 焉算法乃 类型包含变量 类型 变量 也） 字段列表
  | 变体类型 （_, 参数类型列表） ->
      List.exists （夫「_」者受 类型 焉算法乃 类型包含变量 类型 变量 也） 参数类型列表
  | 引用类型 内容类型 ->
      类型包含变量 内容类型 变量
  | 数组类型 元素类型 ->
      类型包含变量 元素类型 变量
...
且有 格式化类型 者 受 类型 焉算法乃
  ...
  | 元组类型 类型列表 ->
      『（』 ^ （字符串连接 『 乘 』 （List.map 格式化类型 类型列表）） ^ 『）』
  | 列表类型 元素类型 ->
      （格式化类型 元素类型） ^ 『 列表』
  | 记录类型 字段列表 ->
      『{ 』 ^ （字符串连接 『; 』 （List.map （夫「_」者受 （名称, 类型） 焉算法乃
        名称 ^ 『: 』 ^ （格式化类型 类型） 也） 字段列表）） ^ 『 }』
  | 变体类型 （名称, 参数类型列表） ->
      名称 ^ （若 参数类型列表=空空如也 则 答 『』
              余者答 『 （』 ^ （字符串连接 『 乘 』 （List.map 格式化类型 参数类型列表）） ^ 『）』）
  | 引用类型 内容类型 ->
      （格式化类型 内容类型） ^ 『 引用』
  | 数组类型 元素类型 ->
      （格式化类型 元素类型） ^ 『 数组』
...
夫 递归 类型表达式到内部类型 者 受 环境 类型表达式 焉算法乃
  ...
  | 函数类型 （参数类型, 返回类型, _） ->
      ...
      函数类型 （参数, 返回）
  | 元组类型 （类型列表, _） ->
      设「内部类型列表」为List.map （类型表达式到内部类型 环境） 类型列表 在
      元组类型 内部类型列表
  | 列表类型 （元素类型, _） ->
      设「元素」为类型表达式到内部类型 环境 元素类型 在
      列表类型 元素
  | 记录类型 （字段列表, _） ->
      设「内部字段列表」为List.map （夫「_」者受 （名称, 类型） 焉算法乃
        （名称, 类型表达式到内部类型 环境 类型） 也） 字段列表 在
      记录类型 内部字段列表
  | 变体类型 （名称, 参数类型列表, _） ->
      设「内部参数类型列表」为List.map （类型表达式到内部类型 环境） 参数类型列表 在
      变体类型 （名称, 内部参数类型列表）
  | 引用类型 （内容类型, _） ->
