...
「：获取当前词法单元：」
夫「当前词法单元」者受 状态 焉算法乃
  如果 状态点当前索引 大于等于List点长度 状态点词法单元列表 则
    无
  余者
    有 （List点第N个 状态点词法单元列表 状态点当前索引）
也

「：预览下一个词法单元：」
夫「预览词法单元」者受 状态 偏移量 焉算法乃
  设「索引」为状态点当前索引 加 偏移量 在
  如果 索引 大于等于List点长度 状态点词法单元列表 则
    无
  余者
    有 （List点第N个 状态点词法单元列表 索引）
也

「：前进到下一个词法单元：」
夫「前进词法单元」者受 状态 焉算法乃
  如果 状态点当前索引 小于 List点长度 状态点词法单元列表 则
...
夫「解析程序」者受 状态 焉算法乃
  ...
  设 递归 解析语句序列为函数 （） 减大于
    ...
    观 当前词法单元 状态 之 性
    或 无 减大于 List点反转 ！语句列表
    或 有 词法单元 减大于
        观「词法单元点类型」之性
        或 文件结束 减大于 List点反转 ！语句列表
        或 下划线 减大于
            观 解析表达式 状态 之 性
            或 有 表达式 减大于
