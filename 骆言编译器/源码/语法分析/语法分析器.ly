...
「：创建语法分析器状态：」
夫 创建语法分析器 者 受 词法单元列表 文件名 焉 算法 乃
  设 错误收集器 为 创建错误收集器 () 在 {
    词法单元列表 = 词法单元列表;
    当前索引 = 0;
    错误收集器 = 错误收集器;
...
「：预览下一个词法单元：」
夫 预览词法单元 者 受 状态 偏移量 焉 算法 乃
  设 索引 为 状态.当前索引 + 偏移量 在
...
「：前进到下一个词法单元：」
夫 前进词法单元 者 受 状态 焉 算法 乃
  if 状态.当前索引 < List.length 状态.词法单元列表 then
    状态.当前索引 := 状态.当前索引 + 1
是谓

「：检查当前词法单元类型：」
夫 检查词法单元类型 者 受 状态 期望类型 焉 算法 乃
  观 当前词法单元 状态 之 性
  | 无 -> false
  | 有 词法单元 -> 
      观 (词法单元.类型, 期望类型) 之 性
...
「：声明解析函数：」
夫 递归 解析表达式 者 受 状态 焉 算法 乃 失败 "待实现" 是谓
和 解析主表达式 者 受 状态 焉 算法 乃 失败 "待实现" 是谓
和 解析一元表达式 者 受 状态 焉 算法 乃 失败 "待实现" 是谓
和 解析二元表达式 者 受 状态 优先级 焉 算法 乃 失败 "待实现" 是谓
和 解析函数调用 者 受 状态 函数表达式 焉 算法 乃 失败 "待实现" 是谓
和 解析模式 者 受 状态 焉 算法 乃 失败 "待实现" 是谓
和 解析类型表达式 者 受 状态 焉 算法 乃 失败 "待实现" 是谓
和 解析语句 者 受 状态 焉 算法 乃 失败 "待实现" 是谓

「：解析主表达式实现：」
夫 解析主表达式 者 受 状态 焉 算法 乃
  跳过换行符 状态;
...
「：二元运算符映射：」
夫 词法单元到二元运算符 者 受 词法单元类型 焉 算法 乃
  观 词法单元类型 之 性
  | 加号 -> 有 加法
  | 减号 -> 有 减法
  | 乘号 -> 有 乘法
...
「：解析二元表达式：」
夫 递归 解析二元表达式 者 受 状态 最小优先级 焉 算法 乃
  观 解析一元表达式 状态 之 性
  | 无 -> 无
  | 有 左表达式 ->
      设 结果 为 ref 左表达式 在
...
「：解析表达式：」
夫 解析表达式 者 受 状态 焉 算法 乃
  解析二元表达式 状态 0
是谓

「：解析程序：」
夫 解析程序 者 受 状态 焉 算法 乃
  设 语句列表 为 ref [] 在
...
「：语法分析入口函数：」
夫 语法分析 者 受 词法单元列表 文件名 焉 算法 乃
  设 状态 为 创建语法分析器 词法单元列表 文件名 在
