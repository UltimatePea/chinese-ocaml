...
夫 生成C代码 者 受 配置 程序 焉 算法 乃
  ...
  让 转义打印 = 转义标识符 "打印" 在
  让 转义读取 = 转义标识符 "读取" 在
  让 转义读取文件 = 转义标识符 "内置_读取文件" 在
  让 转义写入文件 = 转义标识符 "内置_写入文件" 在
  让 转义文件存在 = 转义标识符 "内置_文件存在" 在
  让 转义系统参数 = 转义标识符 "系统_参数列表" 在
  让 转义系统退出 = 转义标识符 "系统_退出" 在
  让 转义字符串长度 = 转义标识符 "内置_字符串长度" 在
  让 转义字符串连接 = 转义标识符 "内置_字符串连接" 在
  让 转义整数转字符串 = 转义标识符 "字符串_从_整数" 在
  让 转义字符串转整数 = 转义标识符 "整数_从_字符串" 在
  包含文件 ^ "\n\n" ^
  函数定义 ^ "\n\n" ^
