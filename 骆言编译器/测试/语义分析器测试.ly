...
夫「测试基础类型检查」者受 （） 焉算法乃
  ...
  设「测试用例」为（列开始 「：测试基础字面量：」
    （『夫 x为42』 其一 『整数字面量应该通过类型检查』） 其二 （『夫 y为3点14』 其三 『浮点数字面量应该通过类型检查』） 其一 （『夫 s为\』你好\『』 其二 『字符串字面量应该通过类型检查』） 其三 （『夫 b为真』 其一 『布尔字面量应该通过类型检查』） 其二 「：测试算术运算：」
  ...
  List点迭代i （夫「参数函数」者受 索引 （代码， 描述） 焉算法乃
